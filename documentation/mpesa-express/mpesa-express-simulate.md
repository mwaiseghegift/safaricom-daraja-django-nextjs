...
|-------------|-------------|-----|
| Sandbox | Testing environment. | [https://sandbox.safaricom.co.ke/mpesa/stkpush/v1/processrequest](https://sandbox.safaricom.co.ke/mpesa/stkpush/v1/processrequest) |
| Production | Live environment for real transactions. | [https://api.safaricom.co.ke/mpesa/stkpush/v1/processrequest](https://api.safaricom.co.ke/mpesa/stkpush/v1/processrequest) |

## Integration Steps

### Sequence Diagram

![lipa-na-mpesa-sequence-diagram](https://daraja.safaricom.co.ke/docs/images/lipa-na-mpesa-sequence-diagram.png)
...
| CallBackURL | The URL where the payment gateway will send the result. | URL | [https://mydomain.com/path](https://mydomain.com/path) |
...
| SFC_IC0003 | The operator does not exist. | Either the TransactionType or PartyB is incorrect. **For BuyGoods/Tills:**- BusinessShortCode: short code used on Go Live- PartyB: Till Number- TransactionType: CustomerBuyGoodsOnline**For Pay Bills:**- BusinessShortCode: short code used on Go Live- PartyB: Pay Bill- TransactionType: CustomerPayBillOnline |
...
![Create App](https://daraja.safaricom.co.ke/docs/images/create-app.png)

![Simulator](https://daraja.safaricom.co.ke/docs/images/simulator.png)
...
![Go Live](https://daraja.safaricom.co.ke/docs/images/go-live.png)
...
![Production App](https://daraja.safaricom.co.ke/docs/images/my-apps-production.png)
...
![org-portal](https://daraja.safaricom.co.ke/docs/images/org-portal.png)
...
![select-operator](https://daraja.safaricom.co.ke/docs/images/select-operator.png)
...
![access-channel](https://daraja.safaricom.co.ke/docs/images/access-channel.png)

6. Then select web profile default rule profile.
7. Then assign role...Business Manager and Set Restricted ORG API PASSWORD.

![assign-role](https://daraja.safaricom.co.ke/docs/images/assign-role.png)
...
![assign-api-role](https://daraja.safaricom.co.ke/docs/images/assign-api-role.png)
...
![Operator Management](https://daraja.safaricom.co.ke/docs/images/operator-management.png)
...
![set-password](https://daraja.safaricom.co.ke/docs/images/set-password.png)
