...
| TrxCode    | Transaction Type. The supported types are:<br>**BG**: Pay Merchant (Buy Goods).<br>**WA**: Withdraw Cash at Agent Till.<br>**PB**: Paybill or Business number.<br>**SM**: Send Money(Mobile number)<br>**SB**: Sent to Business. Business number CPI in MSISDN format. | String | - BG<br>- WA<br>- PB<br>- SM<br>- SB |
