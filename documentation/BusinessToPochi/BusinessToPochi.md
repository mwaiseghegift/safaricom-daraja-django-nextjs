...
The Merchant (Partner) prepares and sends a payment request to the M-PESA B2POCHI API endpoint.
...
**Pochi la Biashara:** The receiving party the B2C organization is disbursing to must have customer business wallet locally known as pochi la biashara or Micro SME
...
| Sandbox
| Testing environment.
| [https://sandbox.safaricom.co.ke/mpesa/b2pochi/v1/paymentrequest](https://sandbox.safaricom.co.ke/mpesa/b2pochi/v1/paymentrequest)

| Production
| Live environment for real transactions.
| [https://api.safaricom.co.ke/mpesa/b2pochi/v1/paymentrequest](https://api.safaricom.co.ke/mpesa/b2pochi/v1/paymentrequest)
...
Your pay bill does not have permission for B2C payments. Apply for a B2C or one account short code at [https://m-pesaforbusiness.co.ke/](https://m-pesaforbusiness.co.ke/).
