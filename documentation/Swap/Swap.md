...
| Sandbox
| Testing environment.
| [https://sandbox.safaricom.co.ke/imsi/v2/checkATI](https://sandbox.safaricom.co.ke/imsi/v2/checkATI)

| Production
| Live environment for real transactions.
| [https://api.safaricom.co.ke/imsi/v2/checkATI](https://api.safaricom.co.ke/imsi/v2/checkATI)
...
![swap-sequence-diagram!](/docs/images/swap-sequence-diagram.png)
...
| responseCode
| A Numeric status code that indicates the status of the transaction submission. 200 means successful submission and any other code means an error occurred.
| Numeric
| 200
